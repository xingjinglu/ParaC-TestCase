  ...
  /* kernel operation */
  {
    ...
    if (value_abs >= THRESHOLD) {
      *pass = 0;
      ...
      //vi[1] = (__global double(*)[256])( (__global char*)V_HDSDt3 + 1 * 256 * 256);
      vi[0] = (__global double(*)[256])( (__global char*)V_HDSDt3 + 0 * 256 * 256);
      ...
      //vj[1] = (__global double(*)[256])( (__global char*)V_HDSDt4 + 1 * 256 * 256);
      vj[0] = (__global double(*)[256])( (__global char*)V_HDSDt4 + 0 * 256 * 256);
