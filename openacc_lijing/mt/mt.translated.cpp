...
timeval end_cpu[10]; 
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_44
void hmpp_acc_region_main_44(int n, float *A, float *B) { 
...
if (true) {
  ...
  ctx->setDeviceHint(4);
  ctx->enterRegion("mt.cpp", 38, 4 /* data */
, 2
, acc_async_sync
);
ctx->pushData(
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("mt.cpp", 44, 65 /* parallel loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(B[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("mt.cpp", 44, "mt", "hmpp_acc_region_main_44");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_44(n, A, B);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("mt.cpp", 44);
#endif // !__HMPP_CG__
}
