...
#ifndef __GPUCODE__
extern "C" CDLT_API  void hmpp_acc_region_main_44(cl_int n_2, cl_float* A_2, cl_float* B_2)
;
#endif /* __GPUCODE__ */
...
#ifndef __GPUCODE__
void hmpp_acc_region_main_44_internal_1(cl_int n, hmpprt::DevicePtr<hmpprt::MS_OPENCL_GLOB,cl_float>  A, hmpprt::DevicePtr<hmpprt::MS_OPENCL_GLOB,cl_float>  B)
;
#endif /* __GPUCODE__ */
...
#ifndef __GPUCODE__
static hmpprt::OpenCLGrid * hmpp_acc_region_main_44_parallel_region_1 = 0;
#else
__kernel  void hmpp_acc_region_main_44_parallel_region_1(__global float* A_1, __global float* B_1, int n_1);
#endif // __GPUCODE__
# 12 "mt.cpp"

#ifdef __GPUCODE__

__kernel __attribute__((reqd_work_group_size(1, 256, 1)))  void hmpp_acc_region_main_44_parallel_region_1(__global float* A_1, __global float* B_1, int n_1)
{
 # 14 "mt.cpp"
 {
  # 45 "mt.cpp"
  ...
  # 45 "mt.cpp"
  # 49 "mt.cpp"
  for (i_2 = first_gang_iter_1 + get_local_id(1) ; i_2 <= last_gang_iter_1 ; i_2 = i_2 + get_local_size(1))
  {
   # 45 "mt.cpp"
   int i_1;
   # 48 "mt.cpp"
...
void hmpp_acc_region_main_44_internal_1(cl_int n, hmpprt::DevicePtr<hmpprt::MS_OPENCL_GLOB,cl_float>  A, hmpprt::DevicePtr<hmpprt::MS_OPENCL_GLOB,cl_float>  B)
{
 ...
 if (1)
 {
  ...
  __hmppcg_call.launch(hmpp_acc_region_main_44_parallel_region_1, hmpprt::Context::getInstance()->getOpenCLDevice());
 }
 ;
}
#endif /* __GPUCODE__ */
...
{
 # 1 "<preprocessor>"
 (hmpp_acc_region_main_44_internal_1(n_2, hmpprt::DevicePtr<hmpprt::MS_OPENCL_GLOB,cl_float> (A_2), hmpprt::DevicePtr<hmpprt::MS_OPENCL_GLOB,cl_float> (B_2)));
}
#endif /* __GPUCODE__ */
...
extern "C" CDLT_API void * hmpprt_init()
{
  try
  {
    if (hmpprt_uses++ == 0)
    {
      ...
      hmpp_acc_region_main_44_parallel_region_1 = new hmpprt::OpenCLGrid(hmpprt_module, "hmpp_acc_region_main_44_parallel_region_1");

    }
    hmpprt::Context::getInstance()->getGrouplet()->setTarget(hmpprt::OPENCL);
    hmpprt::Context::getInstance()->getGrouplet()->addSignature("hmpp_acc_region_main_44", "prototype hmpp_acc_region_main_44(n: s32, A: ^openclglob float, B: ^openclglob float)");
