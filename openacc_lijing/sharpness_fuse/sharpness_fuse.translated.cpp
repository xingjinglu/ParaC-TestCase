...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_82
void hmpp_acc_region_main_82(int width, int height, int quarterWidth, unsigned char *yPlane, unsigned char *yPlaneDown) { 
...
{ 
yPlaneDown[(i / 4) * quarterWidth + j / 4] = (((((((((((((((yPlane[i * width + j] + yPlane[(i * width + j) + 1]) + yPlane[(i * width + j) + 2]) + yPlane[(i * width + j) + 3]) + yPlane[(i + 1) * width + j]) + yPlane[((i + 1) * width + j) + 1]) + yPlane[((i + 1) * width + j) + 2]) + yPlane[((i + 1) * 
# 90
width + j) + 3]) + yPlane[(i + 2) * width + j]) + yPlane[((i + 2) * width + j) + 1]) + yPlane[((i + 2) * width + j) + 2]) + yPlane[((i + 2) * width + j) + 3]) + yPlane[(i + 3) * width + j]) + yPlane[((i + 3) * width + j) + 1]) + yPlane[((i + 3) * width + j) + 2]) + yPlane[((i + 3) * width + j) + 3]) 
# 90
+ 8 >> 4; 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_105
void hmpp_acc_region_main_105(int width, int quarterWidth, int quarterHeight, unsigned char *yPlaneCSER, unsigned char *yPlaneDown) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_117
void hmpp_acc_region_main_117(int width, int quarterHeight, unsigned char *yPlaneCSER) { 
#pragma acc  parallel loop
{ 
# 120
for (int h = 0; h < quarterHeight; h++) 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_138
void hmpp_acc_region_main_138(int &width, int height, unsigned char *yPlaneCSER) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_151
void hmpp_acc_region_main_151(int &width, int quarterWidth, unsigned char *yPlaneCSER, unsigned char *yPlaneDown) { 
#pragma acc  kernels loop independent
{ 
# 154
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_159
void hmpp_acc_region_main_159(int &width, int &height, int quarterWidth, int quarterHeight, unsigned char *yPlaneCSER, unsigned char *yPlaneDown) { 
#pragma acc  kernels loop independent
{ 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_172
void hmpp_acc_region_main_172(int &width, int quarterWidth, unsigned char *yPlaneCSER) { 
#pragma acc  kernels loop independent
{ 
# 175
for (int w = 0; w < quarterWidth; w++) 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_189
void hmpp_acc_region_main_189(int &width, int &height, int quarterWidth, unsigned char *yPlaneCSER) { 
#pragma acc  kernels loop independent
{ 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_211
void hmpp_acc_region_main_211(int &width, unsigned char *yPlaneCSER) { 
#pragma acc  kernels loop independent
{ 
# 214
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_220
void hmpp_acc_region_main_220(int &width, int &height, unsigned char *yPlaneCSER) { 
#pragma acc  kernels loop independent
{ 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_232
void hmpp_acc_region_main_232(int &width, int quarterWidth, int quarterHeight, unsigned char *yPlaneCSER, unsigned char *yPlaneDown) { 
#pragma acc  kernels loop independent
{ 
# 235
for (int h = 0; h < quarterHeight; h++) 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_244
void hmpp_acc_region_main_244(int &width, int quarterHeight, unsigned char *yPlaneCSER) { 
#pragma acc  kernels loop independent
{ 
# 247
for (int h = 0; h < quarterHeight; h++) 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_267
void hmpp_acc_region_main_267(int &width, int height, unsigned char *yPlaneCSER) { 
#pragma acc  kernels loop independent
{ 
# 270
for (int h = 0; h < height; h++) 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_279
void hmpp_acc_region_main_279(int &width, int quarterWidth, int quarterHeight, unsigned char *yPlaneCSER, unsigned char *yPlaneDown) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_316
void hmpp_acc_region_main_316(int width, int height, unsigned char *yPlane, short *pEdge) { 
#pragma acc  parallel loop collapse(2)
{ 
# 319
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_339
void hmpp_acc_region_main_339(int width, int height, short *pEdge, long &sum) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_376
void hmpp_acc_region_main_376(int width, int height, unsigned char *yPlane, unsigned char *yPlaneCSER, short *pError) { 
#pragma acc  parallel loop collapse(2)
{ 
# 379
for (int h = 0; h < height; h++) 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_389
void hmpp_acc_region_main_389(int width, int height, unsigned char *yPlaneCSER, short *pError, short *pEdge, short *pSharpness, double cutoff, double peak, double cutoff2, double order, double order2, double low) { 
#pragma acc  parallel loop collapse(2)
{ 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_408
void hmpp_acc_region_main_408(int width, int height, unsigned char *yPlane, short *pEdge, short *pSharpness, float cutoff3, float order3, float peak3, float low3) { 
#pragma acc  parallel loop collapse(2)
{ 
...
maxValue = (((yPlane[((h - 1) * width + w) - 1] > yPlane[(h - 1) * width + w]) ? (yPlane[((h - 1) * width + w) - 1]) : (yPlane[(h - 1) * width + w])) > yPlane[((h - 1) * width + w) + 1]) ? ((yPlane[((h - 1) * width + w) - 1] > yPlane[(h - 1) * width + w]) ? (yPlane[((h - 1) * width + w) - 1]) : (
# 422
yPlane[(h - 1) * width + w])) : (yPlane[((h - 1) * width + w) + 1]); 
maxValue = (maxValue > ((((yPlane[(h * width + w) - 1] > yPlane[h * width + w]) ? (yPlane[(h * width + w) - 1]) : (yPlane[h * width + w])) > yPlane[(h * width + w) + 1]) ? ((yPlane[(h * width + w) - 1] > yPlane[h * width + w]) ? (yPlane[(h * width + w) - 1]) : (yPlane[h * width + w])) : (yPlane[(h * 
# 423
width + w) + 1]))) ? maxValue : ((((yPlane[(h * width + w) - 1] > yPlane[h * width + w]) ? (yPlane[(h * width + w) - 1]) : (yPlane[h * width + w])) > yPlane[(h * width + w) + 1]) ? ((yPlane[(h * width + w) - 1] > yPlane[h * width + w]) ? (yPlane[(h * width + w) - 1]) : (yPlane[h * width + w])) : (
# 423
yPlane[(h * width + w) + 1])); 
maxValue = (maxValue > ((((yPlane[((h + 1) * width + w) - 1] > yPlane[(h + 1) * width + w]) ? (yPlane[((h + 1) * width + w) - 1]) : (yPlane[(h + 1) * width + w])) > yPlane[((h + 1) * width + w) + 1]) ? ((yPlane[((h + 1) * width + w) - 1] > yPlane[(h + 1) * width + w]) ? (yPlane[((h + 1) * width + w) 
# 424
- 1]) : (yPlane[(h + 1) * width + w])) : (yPlane[((h + 1) * width + w) + 1]))) ? maxValue : ((((yPlane[((h + 1) * width + w) - 1] > yPlane[(h + 1) * width + w]) ? (yPlane[((h + 1) * width + w) - 1]) : (yPlane[(h + 1) * width + w])) > yPlane[((h + 1) * width + w) + 1]) ? ((yPlane[((h + 1) * width + w
# 424
) - 1] > yPlane[(h + 1) * width + w]) ? (yPlane[((h + 1) * width + w) - 1]) : (yPlane[(h + 1) * width + w])) : (yPlane[((h + 1) * width + w) + 1])); 

minValue = (yPlane[((h - 1) * width + w) - 1] < ((yPlane[(h - 1) * width + w] < yPlane[((h - 1) * width + w) + 1]) ? (yPlane[(h - 1) * width + w]) : (yPlane[((h - 1) * width + w) + 1]))) ? (yPlane[((h - 1) * width + w) - 1]) : ((yPlane[(h - 1) * width + w] < yPlane[((h - 1) * width + w) + 1]) ? (
# 426
yPlane[(h - 1) * width + w]) : (yPlane[((h - 1) * width + w) + 1])); 
minValue = (minValue < ((yPlane[(h * width + w) - 1] < ((yPlane[h * width + w] < yPlane[(h * width + w) + 1]) ? (yPlane[h * width + w]) : (yPlane[(h * width + w) + 1]))) ? (yPlane[(h * width + w) - 1]) : ((yPlane[h * width + w] < yPlane[(h * width + w) + 1]) ? (yPlane[h * width + w]) : (yPlane[(h * 
# 427
width + w) + 1])))) ? minValue : ((yPlane[(h * width + w) - 1] < ((yPlane[h * width + w] < yPlane[(h * width + w) + 1]) ? (yPlane[h * width + w]) : (yPlane[(h * width + w) + 1]))) ? (yPlane[(h * width + w) - 1]) : ((yPlane[h * width + w] < yPlane[(h * width + w) + 1]) ? (yPlane[h * width + w]) : (
# 427
yPlane[(h * width + w) + 1]))); 
minValue = (minValue < ((yPlane[((h + 1) * width + w) - 1] < ((yPlane[(h + 1) * width + w] < yPlane[((h + 1) * width + w) + 1]) ? (yPlane[(h + 1) * width + w]) : (yPlane[((h + 1) * width + w) + 1]))) ? (yPlane[((h + 1) * width + w) - 1]) : ((yPlane[(h + 1) * width + w] < yPlane[((h + 1) * width + w) 
# 428
+ 1]) ? (yPlane[(h + 1) * width + w]) : (yPlane[((h + 1) * width + w) + 1])))) ? minValue : ((yPlane[((h + 1) * width + w) - 1] < ((yPlane[(h + 1) * width + w] < yPlane[((h + 1) * width + w) + 1]) ? (yPlane[(h + 1) * width + w]) : (yPlane[((h + 1) * width + w) + 1]))) ? (yPlane[((h + 1) * width + w) 
# 428
- 1]) : ((yPlane[(h + 1) * width + w] < yPlane[((h + 1) * width + w) + 1]) ? (yPlane[(h + 1) * width + w]) : (yPlane[((h + 1) * width + w) + 1]))); 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_462
void hmpp_acc_region_main_462(int width, int height, unsigned char *yPlane, short *pSharpness) { 
#pragma acc  parallel loop collapse(2)
{ 
# 465
for (int h = 0; h < height; h++) 
...
if (true) {
  ...
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 74, 4 /* data */
, 7
, acc_async_sync
);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  /* variable_name = */ "sum",
  /* host_address  = */ & sum,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(sum),
  /* transfer_mode = */ 9/* copyin */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  /* variable_name = */ "yPlane",
  /* host_address  = */ yPlane,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(yPlane[0]),
  /* transfer_mode = */ 11/* copy */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  /* variable_name = */ "yPlaneCSER",
  /* host_address  = */ yPlaneCSER,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  /* variable_name = */ "yPlaneDown",
  /* host_address  = */ yPlaneDown,
  /* start         = */ 0,
  /* length        = */ quarterHeight*quarterWidth,
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  /* variable_name = */ "pError",
  /* host_address  = */ pError,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(pError[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  ...
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(pEdge[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 74,
  /* variable_name = */ "pSharpness",
  /* host_address  = */ pSharpness,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(pSharpness[0]),
  /* transfer_mode = */ 8/* create */);
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 82, 65 /* parallel loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(height),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 82,
  /* variable_name = */ "quarterWidth",
  /* host_address  = */ & quarterWidth,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(quarterWidth),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 82,
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 82, "sharpness_fuse", "hmpp_acc_region_main_82");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_82(width, height, quarterWidth, yPlane, yPlaneDown);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 82);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 105, 65 /* parallel loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 105,
  /* variable_name = */ "quarterHeight",
  /* host_address  = */ & quarterHeight,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(quarterHeight),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 105,
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 105, "sharpness_fuse", "hmpp_acc_region_main_105");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_105(width, quarterWidth, quarterHeight, yPlaneCSER, yPlaneDown);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 105);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 117, 65 /* parallel loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 117, "sharpness_fuse", "hmpp_acc_region_main_117");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_117(width, quarterHeight, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 117);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 138, 66 /* kernels loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 138, "sharpness_fuse", "hmpp_acc_region_main_138");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_138(width, height, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 138);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 151, 66 /* kernels loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 151, "sharpness_fuse", "hmpp_acc_region_main_151");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_151(width, quarterWidth, yPlaneCSER, yPlaneDown);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 151);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 159, 66 /* kernels loop */
, 6
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 159, "sharpness_fuse", "hmpp_acc_region_main_159");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_159(width, height, quarterWidth, quarterHeight, yPlaneCSER, yPlaneDown);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 159);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 172, 66 /* kernels loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 172, "sharpness_fuse", "hmpp_acc_region_main_172");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_172(width, quarterWidth, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 172);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 189, 66 /* kernels loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 189, "sharpness_fuse", "hmpp_acc_region_main_189");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_189(width, height, quarterWidth, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 189);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 211, 66 /* kernels loop */
, 2
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 211, "sharpness_fuse", "hmpp_acc_region_main_211");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_211(width, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 211);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 220, 66 /* kernels loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 220, "sharpness_fuse", "hmpp_acc_region_main_220");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_220(width, height, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 220);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 232, 66 /* kernels loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 232, "sharpness_fuse", "hmpp_acc_region_main_232");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_232(width, quarterWidth, quarterHeight, yPlaneCSER, yPlaneDown);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 232);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 244, 66 /* kernels loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 244, "sharpness_fuse", "hmpp_acc_region_main_244");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_244(width, quarterHeight, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 244);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 267, 66 /* kernels loop */
, 3
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneCSER[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 267, "sharpness_fuse", "hmpp_acc_region_main_267");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_267(width, height, yPlaneCSER);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 267);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 279, 66 /* kernels loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(yPlaneDown[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 279, "sharpness_fuse", "hmpp_acc_region_main_279");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_279(width, quarterWidth, quarterHeight, yPlaneCSER, yPlaneDown);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 279);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 316, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pEdge[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 316, "sharpness_fuse", "hmpp_acc_region_main_316");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_316(width, height, yPlane, pEdge);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 316);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 339, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ 8,
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 339, "sharpness_fuse", "hmpp_acc_region_main_339");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_339(width, height, pEdge, sum);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 339);
#endif // !__HMPP_CG__
}
...
if (true)
{
  openacci::Context * ctx = openacci::Context::getInstance();
  const char *__hmpp_var_names[]      = {"sum"};
  const void *__hmpp_host_addresses[] = {& sum};
  size_t      __hmpp_starts[]         = {0};
  size_t      __hmpp_lengths[]        = {1};
  size_t      __hmpp_elems_sizes[]    = {8};
  int         __hmpp_update_sides[]   = {1};
  ctx->updateDatas(
      /* file_name    = */ "sharpness_fuse.cpp",
      /* line_number  = */ 352,
      /* async_value   = */ acc_async_sync /* SYNC */,
      /* nb_variables = */ 1,
      /* var_names    = */ __hmpp_var_names,
      /* addresses    = */ __hmpp_host_addresses,
      /* starts       = */ __hmpp_starts,
      /* lengths      = */ __hmpp_lengths,
      /* elem_sizes   = */ __hmpp_elems_sizes,
      /* side         = */ __hmpp_update_sides);
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 376, 65 /* parallel loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pError[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 376, "sharpness_fuse", "hmpp_acc_region_main_376");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_376(width, height, yPlane, yPlaneCSER, pError);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 376);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 389, 65 /* parallel loop */
, 12
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 389,
  /* variable_name = */ "cutoff",
  /* host_address  = */ & cutoff,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(cutoff),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 389,
  ...
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(peak),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 389,
  /* variable_name = */ "cutoff2",
  /* host_address  = */ & cutoff2,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(cutoff2),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 389,
  ...
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(order),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 389,
  /* variable_name = */ "order2",
  /* host_address  = */ & order2,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(order2),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 389,
  ...
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(low),
  /* transfer_mode = */ 4/* value */);
ctx->call("sharpness_fuse.cpp", 389, "sharpness_fuse", "hmpp_acc_region_main_389");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_389(width, height, yPlaneCSER, pError, pEdge, pSharpness, cutoff, peak, cutoff2, order, order2, low);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 389);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 408, 65 /* parallel loop */
, 9
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 408,
  /* variable_name = */ "cutoff3",
  /* host_address  = */ & cutoff3,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(cutoff3),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 408,
  /* variable_name = */ "order3",
  /* host_address  = */ & order3,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(order3),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "sharpness_fuse.cpp",
  /* line_number   = */ 408,
...
ctx->pushData(
  ...
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(low3),
  /* transfer_mode = */ 4/* value */);
ctx->call("sharpness_fuse.cpp", 408, "sharpness_fuse", "hmpp_acc_region_main_408");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_408(width, height, yPlane, pEdge, pSharpness, cutoff3, order3, peak3, low3);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 408);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("sharpness_fuse.cpp", 462, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pSharpness[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("sharpness_fuse.cpp", 462, "sharpness_fuse", "hmpp_acc_region_main_462");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_462(width, height, yPlane, pSharpness);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 462);
#endif // !__HMPP_CG__
}
...
if(ctx)
  ctx->leaveRegion("sharpness_fuse.cpp", 74);
#endif // !__HMPP_CG__
}
...
printf("Total: "); } else { 
if (i == 1) { 
printf("DownScale: "); } else { 
if (i == 2) { 
printf("UpScale: "); } else { 
if (i == 3) { 
printf("Sobel+Mean: "); } else { 
if (i == 4) { 
printf("Error+Sharp_Strength+OverShoot: "); } else { 
if (i == 5) { 
printf("Sharp_Cut: "); }  }  }  }  }  }  
...
for (int j = 0; j < width; j += 4) 
{ 
yPlaneDown[(i / 4) * quarterWidth + j / 4] = (((((((((((((((yPlane_cpu[i * width + j] + yPlane_cpu[(i * width + j) + 1]) + yPlane_cpu[(i * width + j) + 2]) + yPlane_cpu[(i * width + j) + 3]) + yPlane_cpu[(i + 1) * width + j]) + yPlane_cpu[((i + 1) * width + j) + 1]) + yPlane_cpu[((i + 1) * width + j
# 517
) + 2]) + yPlane_cpu[((i + 1) * width + j) + 3]) + yPlane_cpu[(i + 2) * width + j]) + yPlane_cpu[((i + 2) * width + j) + 1]) + yPlane_cpu[((i + 2) * width + j) + 2]) + yPlane_cpu[((i + 2) * width + j) + 3]) + yPlane_cpu[(i + 3) * width + j]) + yPlane_cpu[((i + 3) * width + j) + 1]) + yPlane_cpu[((i 
# 517
+ 3) * width + j) + 2]) + yPlane_cpu[((i + 3) * width + j) + 3]) + 8 >> 4; 
...
maxValue = (((yPlane_cpu[((h - 1) * width + w) - 1] > yPlane_cpu[(h - 1) * width + w]) ? (yPlane_cpu[((h - 1) * width + w) - 1]) : (yPlane_cpu[(h - 1) * width + w])) > yPlane_cpu[((h - 1) * width + w) + 1]) ? ((yPlane_cpu[((h - 1) * width + w) - 1] > yPlane_cpu[(h - 1) * width + w]) ? (yPlane_cpu[((
# 739
h - 1) * width + w) - 1]) : (yPlane_cpu[(h - 1) * width + w])) : (yPlane_cpu[((h - 1) * width + w) + 1]); 
maxValue = (maxValue > ((((yPlane_cpu[(h * width + w) - 1] > yPlane_cpu[h * width + w]) ? (yPlane_cpu[(h * width + w) - 1]) : (yPlane_cpu[h * width + w])) > yPlane_cpu[(h * width + w) + 1]) ? ((yPlane_cpu[(h * width + w) - 1] > yPlane_cpu[h * width + w]) ? (yPlane_cpu[(h * width + w) - 1]) : (
# 740
yPlane_cpu[h * width + w])) : (yPlane_cpu[(h * width + w) + 1]))) ? maxValue : ((((yPlane_cpu[(h * width + w) - 1] > yPlane_cpu[h * width + w]) ? (yPlane_cpu[(h * width + w) - 1]) : (yPlane_cpu[h * width + w])) > yPlane_cpu[(h * width + w) + 1]) ? ((yPlane_cpu[(h * width + w) - 1] > yPlane_cpu[h * 
# 740
width + w]) ? (yPlane_cpu[(h * width + w) - 1]) : (yPlane_cpu[h * width + w])) : (yPlane_cpu[(h * width + w) + 1])); 
maxValue = (maxValue > ((((yPlane_cpu[((h + 1) * width + w) - 1] > yPlane_cpu[(h + 1) * width + w]) ? (yPlane_cpu[((h + 1) * width + w) - 1]) : (yPlane_cpu[(h + 1) * width + w])) > yPlane_cpu[((h + 1) * width + w) + 1]) ? ((yPlane_cpu[((h + 1) * width + w) - 1] > yPlane_cpu[(h + 1) * width + w]) ? (
# 741
yPlane_cpu[((h + 1) * width + w) - 1]) : (yPlane_cpu[(h + 1) * width + w])) : (yPlane_cpu[((h + 1) * width + w) + 1]))) ? maxValue : ((((yPlane_cpu[((h + 1) * width + w) - 1] > yPlane_cpu[(h + 1) * width + w]) ? (yPlane_cpu[((h + 1) * width + w) - 1]) : (yPlane_cpu[(h + 1) * width + w])) > 
# 741
yPlane_cpu[((h + 1) * width + w) + 1]) ? ((yPlane_cpu[((h + 1) * width + w) - 1] > yPlane_cpu[(h + 1) * width + w]) ? (yPlane_cpu[((h + 1) * width + w) - 1]) : (yPlane_cpu[(h + 1) * width + w])) : (yPlane_cpu[((h + 1) * width + w) + 1])); 

minValue = (yPlane_cpu[((h - 1) * width + w) - 1] < ((yPlane_cpu[(h - 1) * width + w] < yPlane_cpu[((h - 1) * width + w) + 1]) ? (yPlane_cpu[(h - 1) * width + w]) : (yPlane_cpu[((h - 1) * width + w) + 1]))) ? (yPlane_cpu[((h - 1) * width + w) - 1]) : ((yPlane_cpu[(h - 1) * width + w] < yPlane_cpu[((
# 743
h - 1) * width + w) + 1]) ? (yPlane_cpu[(h - 1) * width + w]) : (yPlane_cpu[((h - 1) * width + w) + 1])); 
minValue = (minValue < ((yPlane_cpu[(h * width + w) - 1] < ((yPlane_cpu[h * width + w] < yPlane_cpu[(h * width + w) + 1]) ? (yPlane_cpu[h * width + w]) : (yPlane_cpu[(h * width + w) + 1]))) ? (yPlane_cpu[(h * width + w) - 1]) : ((yPlane_cpu[h * width + w] < yPlane_cpu[(h * width + w) + 1]) ? (
# 744
yPlane_cpu[h * width + w]) : (yPlane_cpu[(h * width + w) + 1])))) ? minValue : ((yPlane_cpu[(h * width + w) - 1] < ((yPlane_cpu[h * width + w] < yPlane_cpu[(h * width + w) + 1]) ? (yPlane_cpu[h * width + w]) : (yPlane_cpu[(h * width + w) + 1]))) ? (yPlane_cpu[(h * width + w) - 1]) : ((yPlane_cpu[h * 
# 744
width + w] < yPlane_cpu[(h * width + w) + 1]) ? (yPlane_cpu[h * width + w]) : (yPlane_cpu[(h * width + w) + 1]))); 
minValue = (minValue < ((yPlane_cpu[((h + 1) * width + w) - 1] < ((yPlane_cpu[(h + 1) * width + w] < yPlane_cpu[((h + 1) * width + w) + 1]) ? (yPlane_cpu[(h + 1) * width + w]) : (yPlane_cpu[((h + 1) * width + w) + 1]))) ? (yPlane_cpu[((h + 1) * width + w) - 1]) : ((yPlane_cpu[(h + 1) * width + w] < 
# 745
yPlane_cpu[((h + 1) * width + w) + 1]) ? (yPlane_cpu[(h + 1) * width + w]) : (yPlane_cpu[((h + 1) * width + w) + 1])))) ? minValue : ((yPlane_cpu[((h + 1) * width + w) - 1] < ((yPlane_cpu[(h + 1) * width + w] < yPlane_cpu[((h + 1) * width + w) + 1]) ? (yPlane_cpu[(h + 1) * width + w]) : (yPlane_cpu[
# 745
((h + 1) * width + w) + 1]))) ? (yPlane_cpu[((h + 1) * width + w) - 1]) : ((yPlane_cpu[(h + 1) * width + w] < yPlane_cpu[((h + 1) * width + w) + 1]) ? (yPlane_cpu[(h + 1) * width + w]) : (yPlane_cpu[((h + 1) * width + w) + 1]))); 
