...
# 8 "laplacian_fuse.cpp"
timeval start_cpu[10]; 
timeval end_cpu[10]; 
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_55
void hmpp_acc_region_main_55(int height, int width, unsigned char *Source, int *pSrc_padding) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_80
void hmpp_acc_region_main_80(int height, int width, int *pSrc_padding, unsigned char *pBufL_cp) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_94
void hmpp_acc_region_main_94(int height, int width, int *pSrc_padding2, unsigned char *pBufL_cp) { 
#pragma acc  parallel loop collapse(2)
{ 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_108
void hmpp_acc_region_main_108(int height, int width, int *pSrc_padding2, unsigned char *pBufL_cp) { 
...
pSrc_padding2[0 * (width + 4) + w] = ((4 * pBufL_cp[(3 * width + w) - 2] - 4 * pBufL_cp[(1 * width + w) - 2]) + 2 * pBufL_cp[(0 * width + w) - 2]) - 1 * pBufL_cp[(2 * width + w) - 2]; 


pSrc_padding2[(height + 2) * (width + 4) + w] = 2 * pBufL_cp[((height - 2) * width + w) - 2] - 1 * pBufL_cp[((height - 4) * width + w) - 2]; 
pSrc_padding2[(height + 3) * (width + 4) + w] = ((4 * pBufL_cp[((height - 4) * width + w) - 2] - 4 * pBufL_cp[((height - 2) * width + w) - 2]) + 2 * pBufL_cp[((height - 1) * width + w) - 2]) - 1 * pBufL_cp[((height - 3) * width + w) - 2]; 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_130
void hmpp_acc_region_main_130(int height, int width, unsigned char *FilterDst, int *pSrc_padding2) { 
#pragma acc  parallel loop collapse(2)
{ 
# 133
for (int w = 0; w < width; w++) { 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_153
void hmpp_acc_region_main_153(int width, int halfWidth, int halfHeight, unsigned char *FilterDst, unsigned char *DownsampleDst) { 
#pragma acc  parallel loop collapse(2)
{ 
# 156
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_183
void hmpp_acc_region_main_183(int height, int width, int halfWidth, int halfHeight, unsigned char *DownsampleDst, unsigned char *UpsampleDst) { 
#pragma acc  parallel loop
{ 
# 186
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_192
void hmpp_acc_region_main_192(int width, int halfWidth, unsigned char *DownsampleDst, unsigned char *UpsampleDst) { 
#pragma acc  parallel loop
{ 
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_206
void hmpp_acc_region_main_206(int width, int halfWidth, int halfHeight, unsigned char *DownsampleDst, unsigned char *UpsampleDst) { 
#pragma acc  parallel loop gang
{ 
# 209
...
#ifdef __HMPP_CG__
#pragma hmppcg entrypoint as hmpp_acc_region_main_239
void hmpp_acc_region_main_239(int height, int width, unsigned char *Source, short *LaplacianLayer, unsigned char *UpsampleDst) { 
#pragma acc  parallel loop collapse(2)
{ 
# 242
...
if (true) {
  ...
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 47, 4 /* data */
, 8
, acc_async_sync
);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "Source",
  /* host_address  = */ Source,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(Source[0]),
  /* transfer_mode = */ 9/* copyin */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "FilterDst",
  /* host_address  = */ FilterDst,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(FilterDst[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "DownsampleDst",
  /* host_address  = */ DownsampleDst,
  /* start         = */ 0,
  /* length        = */ halfWidth*halfHeight,
  /* element_size  = */ sizeof(DownsampleDst[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "UpsampleDst",
  /* host_address  = */ UpsampleDst,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(UpsampleDst[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "pSrc_padding",
  /* host_address  = */ pSrc_padding,
  /* start         = */ 0,
  /* length        = */ (width+4)*(height+4),
  /* element_size  = */ sizeof(pSrc_padding[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "pSrc_padding2",
  /* host_address  = */ pSrc_padding2,
  /* start         = */ 0,
  /* length        = */ (width+4)*(height+4),
  /* element_size  = */ sizeof(pSrc_padding2[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "pBufL_cp",
  /* host_address  = */ pBufL_cp,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(pBufL_cp[0]),
  /* transfer_mode = */ 8/* create */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 47,
  /* variable_name = */ "LaplacianLayer",
  /* host_address  = */ LaplacianLayer,
  /* start         = */ 0,
  /* length        = */ width*height,
  /* element_size  = */ sizeof(LaplacianLayer[0]),
  /* transfer_mode = */ 10/* copyout */);
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 55, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pSrc_padding[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 55, "laplacian_fuse", "hmpp_acc_region_main_55");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_55(height, width, Source, pSrc_padding);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 55);
#endif // !__HMPP_CG__
}
...
#pragma cap parallel
#pragma cap fuse loop(2, 4) depth(2)
{ 
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 80, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pBufL_cp[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 80, "laplacian_fuse", "hmpp_acc_region_main_80");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_80(height, width, pSrc_padding, pBufL_cp);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 80);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 94, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pBufL_cp[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 94, "laplacian_fuse", "hmpp_acc_region_main_94");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_94(height, width, pSrc_padding2, pBufL_cp);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 94);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 108, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pBufL_cp[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 108, "laplacian_fuse", "hmpp_acc_region_main_108");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_108(height, width, pSrc_padding2, pBufL_cp);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 108);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 130, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(pSrc_padding2[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 130, "laplacian_fuse", "hmpp_acc_region_main_130");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_130(height, width, FilterDst, pSrc_padding2);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 130);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 153, 65 /* parallel loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 153,
  /* variable_name = */ "halfWidth",
  /* host_address  = */ & halfWidth,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(halfWidth),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 153,
  /* variable_name = */ "halfHeight",
  /* host_address  = */ & halfHeight,
  /* start         = */ 0,
  /* length        = */ 1,
  /* element_size  = */ sizeof(halfHeight),
  /* transfer_mode = */ 4/* value */);
ctx->pushData(
  /* file_name     = */ "laplacian_fuse.cpp",
  /* line_number   = */ 153,
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(DownsampleDst[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 153, "laplacian_fuse", "hmpp_acc_region_main_153");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_153(width, halfWidth, halfHeight, FilterDst, DownsampleDst);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 153);
#endif // !__HMPP_CG__
}
...
if (true)
{
  ...
  const char *__hmpp_var_names[]      = {"DownsampleDst"};
  const void *__hmpp_host_addresses[] = {DownsampleDst};
  size_t      __hmpp_starts[]         = {0};
  size_t      __hmpp_lengths[]        = {halfWidth*halfHeight};
  size_t      __hmpp_elems_sizes[]    = {sizeof(DownsampleDst[0])};
...
{
  openacci::Context * ctx = openacci::Context::getInstance();
  const char *__hmpp_var_names[]      = {"UpsampleDst"};
  const void *__hmpp_host_addresses[] = {UpsampleDst};
  size_t      __hmpp_starts[]         = {0};
  size_t      __hmpp_lengths[]        = {width*height};
  size_t      __hmpp_elems_sizes[]    = {sizeof(UpsampleDst[0])};
  int         __hmpp_update_sides[]   = {2};
  ctx->updateDatas(
      /* file_name    = */ "laplacian_fuse.cpp",
      /* line_number  = */ 175,
      /* async_value   = */ acc_async_sync /* SYNC */,
...
{ 
#pragma cap parallel
#pragma cap fuse loop(11,14) depth(1)
{ 
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 183, 65 /* parallel loop */
, 6
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(UpsampleDst[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 183, "laplacian_fuse", "hmpp_acc_region_main_183");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_183(height, width, halfWidth, halfHeight, DownsampleDst, UpsampleDst);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 183);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 192, 65 /* parallel loop */
, 4
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(UpsampleDst[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 192, "laplacian_fuse", "hmpp_acc_region_main_192");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_192(width, halfWidth, DownsampleDst, UpsampleDst);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 192);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 206, 65 /* parallel loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(UpsampleDst[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 206, "laplacian_fuse", "hmpp_acc_region_main_206");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_206(width, halfWidth, halfHeight, DownsampleDst, UpsampleDst);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 206);
#endif // !__HMPP_CG__
}
...
if (true) {
  ctx = openacci::Context::getInstance();
  ctx->setDeviceHint(4);
  ctx->enterRegion("laplacian_fuse.cpp", 239, 65 /* parallel loop */
, 5
, acc_async_sync
);
ctx->pushData(
...
ctx->pushData(
  ...
  /* element_size  = */ sizeof(UpsampleDst[0]),
  /* transfer_mode = */ 283/* ipcopy */);
ctx->call("laplacian_fuse.cpp", 239, "laplacian_fuse", "hmpp_acc_region_main_239");
} else {
#endif // !__HMPP_CG__
#ifdef __HMPP_CG__

hmpp_acc_region_main_239(height, width, Source, LaplacianLayer, UpsampleDst);
#endif // __HMPP_CG__
#ifndef __HMPP_CG__
}
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 239);
#endif // !__HMPP_CG__
}
...
if(ctx)
  ctx->leaveRegion("laplacian_fuse.cpp", 47);
#endif // !__HMPP_CG__
}
...
printf("Total: "); } else { 
if (i == 1) { 
printf("Row_padding: "); } else { 
if (i == 2) { 
printf("Row_filter+Column_padding: "); } else { 
if (i == 3) { 
printf("Column_filter: "); } else { 
if (i == 4) { 
printf("DownSample: "); } else { 
if (i == 5) { 
printf("UpSample: "); } else { 
if (i == 6) { 
printf("Cut: "); }  }  }  }  }  }  }  
