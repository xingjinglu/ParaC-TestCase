...
//#define HEIGHT 1024
//#define WIDTH 256
clock_t simd1, simd2, cpu1, cpu2;
double sum_simd1, sum_simd2, sum_cpu1, sum_cpu2;
...
int main()
{
  ...
  for (int t = 0; t < frame_num; t++)
  {
    ...
    */
	...
	cout <<"SIMD Train1: " << (sum_simd1 / frame_num) / CLOCKS_PER_SEC << endl;
	cout <<"cpu Train1: " << (sum_cpu1 / frame_num) / CLOCKS_PER_SEC << endl;
}
