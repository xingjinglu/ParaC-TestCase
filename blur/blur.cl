  ...
  int intermediateDstShift)
{
  ...
  /* kernel operation */
  {
     ...
     int res1;
    {
      ...
      [0] = ( int) ( *((__global short*) ((__global char*) inSrcDt2 + 0 * sizeof(short) + inSrcStep * 0)));
      res1 = filter_v[0] * [0]; 
      filter_v[0] = ( int) (*((__global short*) ((__global char*) filter_vSrcDt1 + 0 * sizeof(short) + filter_vSrcStep * 1)));
      [0] = ( int) ( *((__global short*) ((__global char*) inSrcDt2 + 0 * sizeof(short) + inSrcStep * 1)));
      res1 += filter_v[0] * [0]; 
      filter_v[0] = ( int) (*((__global short*) ((__global char*) filter_vSrcDt1 + 0 * sizeof(short) + filter_vSrcStep * 2)));
      [0] = ( int) ( *((__global short*) ((__global char*) inSrcDt2 + 0 * sizeof(short) + inSrcStep * 2)));
      res1 += filter_v[0] * [0]; 
    }
  ...
  /* kernel operation */
  {
    ...
    int4 res1;
    {
      ...
      filter_h[2] = ( int) (*((__global short*) ((__global char*) filter_hSrcDt1 + 2 * sizeof(short) + filter_hSrcStep * 0)));
       = convert_int4(vload4(0,  (__global char*)(intermediateSrcDt2) + 0 * intermediateSrcStep + 4 * 0 * sizeof(short)));
      res1.s0 = filter_h[0] * .s0 + filter_h[1] * .s1 + filter_h[2] * .s2;
      res1.s1 = filter_h[0] * .s1 + filter_h[1] * .s2 + filter_h[2] * .s3;
      res1.s2 = filter_h[0] * .s2 + filter_h[1] * .s3;
