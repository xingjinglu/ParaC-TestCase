  ...
  int dstImageDSShift)
{
  ...
  int srcImageSrcIdx4 = srcImageSrcShift + ((float)gidy) *srcImageSrcStep + (512 / 4 - 1) *sizeof(unsigned char);
  int srcImageSrcIdx5 = srcImageSrcShift + ((float)gidy + 1) *srcImageSrcStep;
  int srcImageSrcIdx6 = srcImageSrcShift + ((float)gidy + 1) *srcImageSrcStep + (512 / 4 - 1) *sizeof(unsigned char);
  ...
  int dstImageDSIdx3 = dstImageDSShift + ((float)gidy * 4) *dstImageDSStep + (512 - 1) *sizeof(unsigned char);
  int dstImageDSIdx4 = dstImageDSShift + ((float)gidy * 4) *dstImageDSStep + (512 - 2) *sizeof(unsigned char);
  ...
  int dstImageDSIdx7 = dstImageDSShift + ((float)gidy * 4 + 1) *dstImageDSStep + (512 - 1) *sizeof(unsigned char);
  int dstImageDSIdx8 = dstImageDSShift + ((float)gidy * 4 + 1) *dstImageDSStep + (512 - 2) *sizeof(unsigned char);
  int dstImageDSIdx9 = dstImageDSShift + ((float)gidy * 4 + 2) *dstImageDSStep + (512 - 1) *sizeof(unsigned char);
  int dstImageDSIdx10 = dstImageDSShift + ((float)gidy * 4 + 2) *dstImageDSStep + (512 - 2) *sizeof(unsigned char);
  int dstImageDSIdx11 = dstImageDSShift + ((float)gidy * 4 + 3) *dstImageDSStep + (512 - 1) *sizeof(unsigned char);
  int dstImageDSIdx12 = dstImageDSShift + ((float)gidy * 4 + 3) *dstImageDSStep + (512 - 2) *sizeof(unsigned char);
  ...
  int dstImageDSShift)
{
  ...
  int srcImageSrcIdx5 = srcImageSrcShift + (512 / 4 - 1) *srcImageSrcStep + ((float)gidx) *sizeof(unsigned char);
  int srcImageSrcIdx6 = srcImageSrcShift + (512 / 4 - 1) *srcImageSrcStep + ((float)gidx + 1) *sizeof(unsigned char);
  ...
  int dstImageDSIdx5 = dstImageDSShift + (512 - 1) *dstImageDSStep + ((float)gidx * 4) *sizeof(unsigned char);
  int dstImageDSIdx6 = dstImageDSShift + (512 - 1) *dstImageDSStep + ((float)gidx * 4 + 1) *sizeof(unsigned char);
  int dstImageDSIdx7 = dstImageDSShift + (512 - 2) *dstImageDSStep + ((float)gidx * 4) *sizeof(unsigned char);
  int dstImageDSIdx8 = dstImageDSShift + (512 - 2) *dstImageDSStep + ((float)gidx * 4 + 1) *sizeof(unsigned char);
