...
int   pEdgeShift)
{
  ...
  pError_float4 = clamp(enhancedF,convert_int4(0),convert_float4(255));  //pError_float4=tt_enhanced 
  edge2Order    = mad(-strength,minValueF-enhancedF,minValueF);   //strength=oscStrength
  strength      = min(mad(strength,enhancedF - maxValueF,maxValueF),convert_float4(255));  //strength=oscStrength
