...
#pragma OPENCL EXTENSION cl_nviidia_printf :enable
...
//    _rtemp0 = *((__global uchar4*)(mad24(2, pImageSrcSrcStep, pImageSrcSrcDt1)));
    _rtemp0 = *((__global uchar4*)(2 * pImageSrcSrcStep + pImageSrcSrcDt1));
    _sum  +=  _rtemp0.s0 + _rtemp0.s1 + _rtemp0.s2 + _rtemp0.s3;

    _rtemp0 = *((__global uchar4*)(3 * pImageSrcSrcStep + pImageSrcSrcDt1));
    _sum  +=  _rtemp0.s0     +     _rtemp0.s1 + _rtemp0.s2 + _rtemp0.s3  ;
    *pImageDstDstDt1 = (_sum + 8)  >> 4;
#endif
...
int dstImageDSIdx1, dstImageDSIdx2, dstImageDSIdx3, dstImageDSIdx4;
...
__global unsigned char *dstImageDSDt1, *dstImageDSDt2, *dstImageDSDt3, *dstImageDSDt4;
