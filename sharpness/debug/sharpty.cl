  ...
  /* kernel operation */
  {
    if (gidx == 1024 / 4 - 1) {
      ...
      *( (float*)Result3 + 3) = *( (float*)Result2 + 3) + *( (float*) Result1 + 3);
      ...
      for(int j=0;j<4;j++)
      *( (__global unsigned char*)((__global char*)dstImageDSDt3 + j * sizeof(unsigned char)) ) = *( ( float*)( ( char*)Result3) + j );
      ...
      *( (float*)Result6 + 3) = *( (float*)Result5 + 3) + *( (float*) Result4 + 3);
      ...
      for(int j=0;j<4;j++)
      *( (__global unsigned char*)((__global char*)dstImageDSDt5 + j * sizeof(unsigned char)) ) = *( ( float*)( ( char*)Result6) + j );
  ...
  int pEdgeDstShift)
{
  ...
  /* kernel operation */
  {
    ...
    int4 res1;
    {
      ...
      yPlane = convert_uchar4(vload4(0, yPlaneSrcDt3 + 0 * yPlaneSrcStep + 4 * 0));
      res1.s0 = ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s0)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gy[2])) * ((convert_int4)(yPlane.s2));
      res1.s1 = ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gy[2])) * ((convert_int4)(yPlane.s3));
      res1.s2 = ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res1.s2 += ((convert_int4)(gy[2])) * ((convert_int4)(R2Next));
      res1.s3 = ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res1.s3 += ((convert_int4)(gy[1])) * ((convert_int4)(R2Next));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 1));
      res1.s3 += ((convert_int4)(gy[1])) * ((convert_int4)(R2Next));
      gy[0] = *(gySrcDt2 + 0 + gySrcStep * 1);
      gy[1] = *(gySrcDt2 + 1 + gySrcStep * 1);
      gy[2] = *(gySrcDt2 + 2 + gySrcStep * 1);
      yPlane = convert_uchar4(vload4(0, yPlaneSrcDt3 + 1 * yPlaneSrcStep + 4 * 0));
      res1.s0 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s0)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gy[2])) * ((convert_int4)(yPlane.s2));
      res1.s1 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gy[2])) * ((convert_int4)(yPlane.s3));
      res1.s2 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 1 + 4 * 1 + 0));
      res1.s2 += ((convert_int4)(gy[2])) * ((convert_int4)(R2Next));
      res1.s3 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 1 + 4 * 1 + 0));
      res1.s3 += ((convert_int4)(gy[1])) * ((convert_int4)(R2Next));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 1 + 4 * 1 + 1));
      res1.s3 += ((convert_int4)(gy[1])) * ((convert_int4)(R2Next));
      gy[0] = *(gySrcDt2 + 0 + gySrcStep * 2);
      gy[1] = *(gySrcDt2 + 1 + gySrcStep * 2);
      gy[2] = *(gySrcDt2 + 2 + gySrcStep * 2);
      yPlane = convert_uchar4(vload4(0, yPlaneSrcDt3 + 2 * yPlaneSrcStep + 4 * 0));
      res1.s0 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s0)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gy[2])) * ((convert_int4)(yPlane.s2));
      res1.s1 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gy[2])) * ((convert_int4)(yPlane.s3));
      res1.s2 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gy[1])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 2 + 4 * 1 + 0));
      res1.s2 += ((convert_int4)(gy[2])) * ((convert_int4)(R2Next));
      res1.s3 += ((convert_int4)(gy[0])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 2 + 4 * 1 + 0));
      res1.s3 += ((convert_int4)(gy[1])) * ((convert_int4)(R2Next));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 2 + 4 * 1 + 1));
      res1.s3 += ((convert_int4)(gy[1])) * ((convert_int4)(R2Next));
    }
        char gx[3];
    int4 res2;
    {
      ...
      yPlane = convert_uchar4(vload4(0, yPlaneSrcDt3 + 0 * yPlaneSrcStep + 4 * 0));
      res2.s0 = ((convert_int4)(gx[0])) * ((convert_int4)(yPlane.s0)) + ((convert_int4)(gx[1])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gx[2])) * ((convert_int4)(yPlane.s2));
      res2.s1 = ((convert_int4)(gx[0])) * ((convert_int4)(yPlane.s1)) + ((convert_int4)(gx[1])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gx[2])) * ((convert_int4)(yPlane.s3));
      res2.s2 = ((convert_int4)(gx[0])) * ((convert_int4)(yPlane.s2)) + ((convert_int4)(gx[1])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res2.s2 += ((convert_int4)(gx[2])) * ((convert_int4)(R2Next));
      res2.s3 = ((convert_int4)(gx[0])) * ((convert_int4)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res2.s3 += ((convert_int4)(gx[1])) * ((convert_int4)(R2Next));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 1));
      res2.s3 += ((convert_int4)(gx[1])) * ((convert_int4)(R2Next));
    ...
    ushort4 temp0;
    ushort4 temp1;
    if (gidx == 0 || gidx == 0 || gidx == 1024 - 1 || gidx == 1024 - 1)
      temp1 = 0;
    else
...
pError = convert_float4( Op_ans1 );
    int4 Op_ans2 = ((convert_int4)  (*((__global ushort4*) pEdgeSrcDt4))) * ( (convert_int4) (*((__global ushort4*) pEdgeSrcDt4)));
      int4 MatrixSub_ans1 = (convert_int4) (*((__global ushort4*) pEdgeSrcDt4));
      int4 MatrixSub_ans2 = (convert_int4) (*((__global ushort4*) pEdgeSrcDt4));
    float4 edge2Order = convert_float4(Op_ans2 * convert_int4(MatrixSub_ans1) * convert_int4(MatrixSub_ans2));
