  ...
  int pEdgeDstShift)
{
  ...
  /* kernel operation */
  {
    ...
    int4 res1;
    {
      ...
      res1.s0 = ((int)(gy[0])) * ((int)(yPlane.s0)) + ((int)(gy[1])) * ((int)(yPlane.s1)) + ((int)(gy[2])) * ((int)(yPlane.s2));
      res1.s1 = ((int)(gy[0])) * ((int)(yPlane.s1)) + ((int)(gy[1])) * ((int)(yPlane.s2)) + ((int)(gy[2])) * ((int)(yPlane.s3));
      res1.s2 = ((int)(gy[0])) * ((int)(yPlane.s2)) + ((int)(gy[1])) * ((int)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res1.s2 += ((int)(gy[2])) * R2Next; 
      res1.s3 = ((int)(gy[0])) * ((int)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res1.s3 += ((int)(gy[1])) * R2Next; 
    ...
    int4 res2;
    {
      ...
      yPlane = convert_uchar4(vload4(0, yPlaneSrcDt3 + 0 * yPlaneSrcStep + 4 * 0));
      res2.s0 = ((int)(gx[0])) * ((int)(yPlane.s0)) + ((int)(gx[1])) * ((int)(yPlane.s1)) + ((int)(gx[2])) * ((int)(yPlane.s2));
      res2.s1 = ((int)(gx[0])) * ((int)(yPlane.s1)) + ((int)(gx[1])) * ((int)(yPlane.s2)) + ((int)(gx[2])) * ((int)(yPlane.s3));
      res2.s2 = ((int)(gx[0])) * ((int)(yPlane.s2)) + ((int)(gx[1])) * ((int)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res2.s2 += ((int)(gx[2])) * R2Next; 
      res2.s3 = ((int)(gx[0])) * ((int)(yPlane.s3));
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 0));
      res2.s3 += ((int)(gx[1])) * R2Next; 
      R2Next = (int)(*(yPlaneSrcDt3 + yPlaneSrcStep * 0 + 4 * 1 + 1));
      res2.s3 += ((int)(gx[1])) * R2Next; 
