  ...
  /* kernel operation */
  {
    ...
    __global unsigned char *SrcRepDt_Pre3 = SrcSrc + SrcIndex_Pre03;
     ...
     int pre01 = *SrcRepDt_Pre1 * 2 - *SrcRepDt_Pre3;
            int SrcIndex_Lat02 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (256 - 1) * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat2 = SrcSrc + SrcIndex_Lat02;
    int SrcIndex_Lat00 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (256 - 2) * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat0 = SrcSrc + SrcIndex_Lat00;
    int SrcIndex_Lat03 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (256 - 3) * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat3 = SrcSrc + SrcIndex_Lat03;
    int SrcIndex_Lat01 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (256 - 4) * sizeof(unsigned char);
  ...
  int dst_dsDstShift)
{
  ...
  /* kernel operation */
  {
    ...
    __global unsigned char *SrcRepDt_Pre3 = dst_horizonSrc + SrcIndex_Pre03;
     ...
     int SrcIndex_Lat02 = dst_horizonSrcShift + ((float)(256 - 1)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat2 = dst_horizonSrc + SrcIndex_Lat02;

    int SrcIndex_Lat00 = dst_horizonSrcShift + ((float)(256 - 2)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat0 = dst_horizonSrc + SrcIndex_Lat00;

    int SrcIndex_Lat03 = dst_horizonSrcShift + ((float)(256 - 3)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat3 = dst_horizonSrc + SrcIndex_Lat03;

    int SrcIndex_Lat01 = dst_horizonSrcShift + ((float)(256 - 4)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    ...
    else if (gidy != 0 && gidy != 1 && gidy != 126 && gidy != 127) {
  ...
  int layerDstShift)
{
  ...
  int SrcSrcIdx3 = SrcSrcShift + (256 - 1) *SrcSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
  int SrcSrcIdx4 = SrcSrcShift + (256 - 1) *SrcSrcStep + ((float)gidx * 2 + 1) *sizeof(unsigned char);
  ...
  int dst_dsSrcIdx9 = dst_dsSrcShift + ((256 + 1) / 2 - 1) *dst_dsSrcStep + ((float)gidx) *sizeof(unsigned char);
  int dst_dsSrcIdx10 = dst_dsSrcShift + ((256 + 1) / 2 - 1) *dst_dsSrcStep + ((float)gidx + 1) *sizeof(unsigned char);
  ...
  int dst_dsSrcIdx13 = dst_dsSrcShift + (128 - 1) *dst_dsSrcStep + ((float)gidx) *sizeof(unsigned char);
  ...
  int layerDstIdx3 = layerDstShift + (256 - 1) *layerDstStep + ((float)gidx * 2) *sizeof(short);
  int layerDstIdx4 = layerDstShift + (256 - 1) *layerDstStep + ((float)gidx * 2 + 1) *sizeof(short);
  ...
  /* kernel operation */
  {
    if (gidy == 0) {
      ...
      *layerDstDt1 = (short)Op_ans1;
      ...
      if (gidx == (256 + 1) / 2 - 1 && widthOdd == 0)
        *layerDstDt2 = (short)Op_ans3;
    }
    if (heightOdd == 0 && gidy == (256 + 1) / 2 - 1) {
