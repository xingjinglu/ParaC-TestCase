  ...
  /* kernel operation */
  {
    ...
    __global unsigned char *SrcRepDt_Pre3 = SrcSrc + SrcIndex_Pre03;
     ...
     int pre01 = *SrcRepDt_Pre1 * 2 - *SrcRepDt_Pre3;
            int SrcIndex_Lat02 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (1024 - 1) * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat2 = SrcSrc + SrcIndex_Lat02;
    int SrcIndex_Lat00 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (1024 - 2) * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat0 = SrcSrc + SrcIndex_Lat00;
    int SrcIndex_Lat03 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (1024 - 3) * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat3 = SrcSrc + SrcIndex_Lat03;
    int SrcIndex_Lat01 = SrcSrcShift + ((float)gidy) * SrcSrcStep + (1024 - 4) * sizeof(unsigned char);
  ...
  int dst_dsDstShift)
{
  ...
  /* kernel operation */
  {
    ...
    __global unsigned char *SrcRepDt_Pre3 = dst_horizonSrc + SrcIndex_Pre03;
     ...
     int SrcIndex_Lat02 = dst_horizonSrcShift + ((float)(1024 - 1)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat2 = dst_horizonSrc + SrcIndex_Lat02;

    int SrcIndex_Lat00 = dst_horizonSrcShift + ((float)(1024 - 2)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat0 = dst_horizonSrc + SrcIndex_Lat00;

    int SrcIndex_Lat03 = dst_horizonSrcShift + ((float)(1024 - 3)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    __global unsigned char *SrcRepDt_Lat3 = dst_horizonSrc + SrcIndex_Lat03;

    int SrcIndex_Lat01 = dst_horizonSrcShift + ((float)(1024 - 4)) * dst_horizonSrcStep + gidx * 2 * sizeof(unsigned char);
    ...
    else if (gidy != 0 && gidy != 1 && gidy != 511 && gidy != 510) {
  ...
  int layerDstShift)
{
  ...
  int dst_dsSrcIdx13 = dst_dsSrcShift + (512 - 1) *dst_dsSrcStep + ((float)gidx) *sizeof(unsigned char);
