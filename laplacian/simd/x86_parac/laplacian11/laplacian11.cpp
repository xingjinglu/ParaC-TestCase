...
int Laplacian_simd(unsigned char (*Src)[1024][1024], unsigned char (*layer)[1024][1024]) {
  ...
  for(int i = 0; i < 1024; i++){
    ...
    res1 =  (int16_t)  SrcPre2;
    res1 += (int16_t)( 4* SrcPre1);
    res1 += (int16_t)(6 * (*Src)[i][0]);
    res1 += (int16_t)(4 * (*Src)[i][1]);
    res1 += (int16_t)((*Src)[i][2]);
    dst_horizon[i][0] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t)SrcPre1;
    res1 += (int16_t) (4 * (*Src)[i][0]);
    res1 += (int16_t) (6 * (*Src)[i][1]);
    res1 += (int16_t) (4 * (*Src)[i][2]);
    res1 += (int16_t) ( (*Src)[i][3]);
    dst_horizon[i][1] = (unsigned char) ((res1 + 8) / 16);

    for(int j = 2; j < 1018; j += 8){
...
#if 0
    Src_Src1 = _mm_loadl_epi64( (__m128i const*)&(*Src)[i][1018 - 2] );
    Src_Src1 = _mm_cvtepu8_epi16(Src_Src1);
    Src_Src2 = _mm_loadl_epi64( (__m128i const*)&(*Src)[i][1018 - 1] );
    Src_Src2 = _mm_cvtepu8_epi16(Src_Src2);
    Src_Src3 = _mm_loadl_epi64( (__m128i const*)&(*Src)[i][1018] );
    Src_Src3 = _mm_cvtepu8_epi16(Src_Src3);
    Src_Src4 = _mm_loadl_epi64( (__m128i const*)&(*Src)[i][1018 + 1] );
    Src_Src4 = _mm_cvtepu8_epi16(Src_Src4);
    Src_Src5 = _mm_loadl_epi64( (__m128i const*)&(*Src)[i][1018 + 2] );
    Src_Src5 = _mm_cvtepu8_epi16(Src_Src5);
    ...
    add = _mm_srli_epi16(add, 4);
    add = _mm_shuffle_epi8(add, Mask1);
    _mm_storeu_si128((__m128i *)&dst_horizon[i][1018], add);
#endif

#if 1
    res1 =  (int16_t)  (*Src)[i][1016];
    res1 += (int16_t) (4 * (*Src)[i][1017]);
    res1 += (int16_t) (6 * (*Src)[i][1018]);
    res1 += (int16_t) (4 * (*Src)[i][1019]);
    res1 += (int16_t)  (*Src)[i][1020];
    dst_horizon[i][1018] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t) ( (*Src)[i][1017]);
    res1 += (int16_t) ( 4 * (*Src)[i][1018]);
    res1 += (int16_t) ( 6 * (*Src)[i][1019]);
    res1 += (int16_t) ( 4 * (*Src)[i][1020]);
    res1 += (int16_t) ( (*Src)[i][1021]);
    dst_horizon[i][1019] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t) (*Src)[i][1018];
    res1 += (int16_t) (4 * (*Src)[i][1019]);
    res1 += (int16_t) (6 * (*Src)[i][1020]);
    res1 += (int16_t) (4 * (*Src)[i][1021]);
    res1 += (int16_t)  (*Src)[i][1022];
    dst_horizon[i][1020] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t) ( (*Src)[i][1019]);
    res1 += (int16_t) (4 * (*Src)[i][1020]);
    res1 += (int16_t) (6 * (*Src)[i][1021]);
    res1 += (int16_t) (4 * (*Src)[i][1022]);
    res1 += (int16_t)  (*Src)[i][1023];
    dst_horizon[i][1021] = (unsigned char) ((res1 + 8) / 16);
#endif



#if 0
    res1 =  (int16_t) (filter_horizon[0][0] * (*Src)[i][1016]);
    res1 += (int16_t) (filter_horizon[0][1] * (*Src)[i][1017]);
    res1 += (int16_t) (filter_horizon[0][2] * (*Src)[i][1018]);
    res1 += (int16_t) (filter_horizon[0][3] * (*Src)[i][1019]);
    res1 += (int16_t) (filter_horizon[0][4] * (*Src)[i][1020]);
    dst_horizon[i][1018] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t) (filter_horizon[0][0] * (*Src)[i][1017]);
    res1 += (int16_t) (filter_horizon[0][1] * (*Src)[i][1018]);
    res1 += (int16_t) (filter_horizon[0][2] * (*Src)[i][1019]);
    res1 += (int16_t) (filter_horizon[0][3] * (*Src)[i][1020]);
    res1 += (int16_t) (filter_horizon[0][4] * (*Src)[i][1021]);
    dst_horizon[i][1019] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t) (filter_horizon[0][0] * (*Src)[i][1018]);
    res1 += (int16_t) (filter_horizon[0][1] * (*Src)[i][1019]);
    res1 += (int16_t) (filter_horizon[0][2] * (*Src)[i][1020]);
    res1 += (int16_t) (filter_horizon[0][3] * (*Src)[i][1021]);
    res1 += (int16_t) (filter_horizon[0][4] * (*Src)[i][1022]);
    dst_horizon[i][1020] = (unsigned char) ((res1 + 8) / 16);

    res1 =  (int16_t) (filter_horizon[0][0] * (*Src)[i][1019]);
    res1 += (int16_t) (filter_horizon[0][1] * (*Src)[i][1020]);
    res1 += (int16_t) (filter_horizon[0][2] * (*Src)[i][1021]);
    res1 += (int16_t) (filter_horizon[0][3] * (*Src)[i][1022]);
    res1 += (int16_t) (filter_horizon[0][4] * (*Src)[i][1023]);
    dst_horizon[i][1021] = (unsigned char) ((res1 + 8) / 16);
#endif
    res1 =  (int16_t) (filter_horizon[0][0] * (*Src)[i][1020]);
    res1 += (int16_t) (filter_horizon[0][1] * (*Src)[i][1021]);
