...
int Laplacian_simd(unsigned char (*Src)[1024][1024], unsigned char (*layer)[1024][1024]) {
  ...
  __m128i filter_horizon_Src1 = _mm_set1_epi16((int16_t)(1));
  __m128i filter_horizon_Src2 = _mm_set1_epi16((int16_t)4);
  __m128i filter_horizon_Src3 = _mm_set1_epi16((int16_t)6);
  __m128i filter_horizon_Src4 = _mm_set1_epi16((int16_t)4);
  __m128i filter_horizon_Src5 = _mm_set1_epi16((int16_t)1);
  ...
  for(int i = 0; i < 1024; i++){
    SrcPre2 = (int16_t) (((*Src)[i][3]<<2) - ((*Src)[i][1]<<2) + ((*Src)[i][0]<<1)  - (*Src)[i][2]);
    SrcPre1 = (int16_t) (((*Src)[i][1]<<1) - (*Src)[i][3]);
    SrcLat1 = (int16_t) ( ((*Src)[i][1024 - 2]<<1) - (*Src)[i][1024 - 4]);
    SrcLat2 = (int16_t) ( ((*Src)[i][1024 - 4]<<2) - ((*Src)[i][1024 - 2]<<2) + ((*Src)[i][1024 - 1]<<1) - (*Src)[i][1024 - 3]);

    res1 =  (int16_t)  SrcPre2;
    res1 += (int16_t)( SrcPre1<<2);
    res1 += (int16_t)(6 * (*Src)[i][0]);
    res1 += (int16_t)((*Src)[i][1]<<2);
    res1 += (int16_t)((*Src)[i][2]);
    dst_horizon[i][0] = (unsigned char) ((res1 + 8)>>4);

    res1 =  (int16_t)SrcPre1;
    res1 += (int16_t) ((*Src)[i][0]<<2);
    res1 += (int16_t) (6 * (*Src)[i][1]);
    res1 += (int16_t) ((*Src)[i][2]<<2);
    res1 += (int16_t) ( (*Src)[i][3]);
    dst_horizon[i][1] = (unsigned char) ((res1 + 8)>>4);
    ...
    res1 += (int16_t) ( (*Src)[i][1017]<<2);
    res1 += (int16_t) (6 * (*Src)[i][1018]);
    res1 += (int16_t) ( (*Src)[i][1019]<<2);
    res1 += (int16_t)  (*Src)[i][1020];
    dst_horizon[i][1018] = (unsigned char) ((res1 + 8) >>4);

    res1 =  (int16_t) ( (*Src)[i][1017]);
    res1 += (int16_t) ( (*Src)[i][1018]<<2);
    res1 += (int16_t) ( 6 * (*Src)[i][1019]);
    res1 += (int16_t) ( (*Src)[i][1020]<<2);
    res1 += (int16_t) ( (*Src)[i][1021]);
    dst_horizon[i][1019] = (unsigned char) ((res1 + 8) >>4);

    res1 =  (int16_t) (*Src)[i][1018];
    res1 += (int16_t) ((*Src)[i][1019]<<2);
    res1 += (int16_t) (6 * (*Src)[i][1020]);
    res1 += (int16_t) ((*Src)[i][1021]<<2);
    res1 += (int16_t)  (*Src)[i][1022];
    dst_horizon[i][1020] = (unsigned char) ((res1 + 8) >>4);

    res1 =  (int16_t) ( (*Src)[i][1019]);
    res1 += (int16_t) ( (*Src)[i][1020]<<2);
    res1 += (int16_t) (6* (*Src)[i][1021]);
    res1 += (int16_t) ( (*Src)[i][1022]<<2);
    res1 += (int16_t)  (*Src)[i][1023];
    dst_horizon[i][1021] = (unsigned char) ((res1 + 8) >>4 );

    res1 =  (int16_t) ( (*Src)[i][1020]);
    res1 += (int16_t) ((*Src)[i][1021]<<2);
    res1 += (int16_t) (6 * (*Src)[i][1022]);
    res1 += (int16_t) ((*Src)[i][1023]<<2);
    res1 += (int16_t)SrcLat1;
    dst_horizon[i][1022] = (unsigned char) ((res1 + 8)>>4);

    res1 =  (int16_t) ( (*Src)[i][1021]);
    res1 += (int16_t) ((*Src)[i][1022]<<2);
    res1 += (int16_t) (6 * (*Src)[i][1023]);
    res1 += (int16_t)( SrcLat1<<2);
    res1 += (int16_t) SrcLat2;
    dst_horizon[i][1023] = (unsigned char) ((res1 + 8)>>4);
  ...
  dst_horizon_Pre1 = _mm_cvtepu8_epi16(dst_horizon_Pre1);
   ...
   dst_horizon_Lat1 = _mm_cvtepu8_epi16(dst_horizon_Lat1);
    ...
    for(int i = 1; i < 511; i += 1){
      ...
      //dst_horizon_Pre4 = _mm_shuffle_epi8(dst_horizon_Pre4, Mask1);
      dst_horizon_Pre5 = _mm_shuffle_epi8(dst_horizon_Pre5, Mask1);
