...
// Index and Operand for BorderRule 
    ...
    int dst_horizonBRIndex8 = dst_horizonSrcShift + (4096 - 1) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex6 = dst_horizonSrcShift + (4096 - 2) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex10 = dst_horizonSrcShift +(4096 - 3) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex7 = dst_horizonSrcShift + (4096 - 4) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
  ...
  int layerDstShift)
{
  ...
  // layer[M-1][ity*2]
  int layerDstIdx3 = layerDstShift + 4095 *layerDstStep + ((float)gidx * 2) *sizeof(unsigned char);
  ...
  int SrcSrcIdx3 = SrcSrcShift + 4095 *SrcSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
  ...
  // dst_ds[(M+1)/2-1][ity]
  int dst_dsSrcIdx9 = dst_dsSrcShift + 2047 *dst_dsSrcStep + ((float)gidx) *sizeof(unsigned char);
