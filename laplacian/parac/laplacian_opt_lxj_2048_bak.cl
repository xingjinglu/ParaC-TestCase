  ...
  int dst_horizonDstShift)
{
  ...
  int SrcBRIndex8 = SrcSrcShift + ((float)gidy) *SrcSrcStep + (2048 - 1) *sizeof(unsigned char);
  int SrcBRIndex6 = SrcSrcShift + ((float)gidy) *SrcSrcStep + (2048 - 2) *sizeof(unsigned char);
  int SrcBRIndex10 = SrcSrcShift + ((float)gidy) *SrcSrcStep + (2048 - 3) *sizeof(unsigned char);
  int SrcBRIndex7 = SrcSrcShift + ((float)gidy) *SrcSrcStep + (2048 - 4) *sizeof(unsigned char);
...
// Index and Operand for BorderRule 
    ...
    int dst_horizonBRIndex8 = dst_horizonSrcShift + (2048 - 1) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex6 = dst_horizonSrcShift + (2048 - 2) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex10 = dst_horizonSrcShift + (2048 - 3) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex7 = dst_horizonSrcShift + (2048 - 4) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
  ...
  int layerDstShift)
{
  ...
  // layer[M-1][ity*2]
  int layerDstIdx3 = layerDstShift + 2047 *layerDstStep + ((float)gidx * 2) *sizeof(unsigned char);
  ...
  src0.s0 =(int) *((__global uchar*)(SrcSrcDt1));
  src0.s1 =(int) *((__global uchar*)(SrcSrcDt1+1));

  // Src[M-1][ity*2], [ity*2+1]
  int SrcSrcIdx3 = SrcSrcShift + 2047 *SrcSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
  __global unsigned char *SrcSrcDt3 = SrcSrc + SrcSrcIdx3;
  //src1 = (convert_int2)(*((__global uchar2*)(SrcSrcDt3)));
  src1.s0 = (int)*((__global uchar*)(SrcSrcDt3));
  src1.s1 = (int)*((__global uchar*)(SrcSrcDt3+1));
  ...
  //src2.s0 = (int)*((__global uchar*)(SrcSrcDt5));
  //src2.s1 = (int)*((__global uchar*)(SrcSrcDt5+1));
  ...
  src3.s0 = (int)*((__global uchar*)(SrcSrcDt7));
  src3.s1 = (int)*((__global uchar*)(SrcSrcDt7+1));
  ...
  dst_ds0.s0 =(int) *((__global uchar*)(dst_dsSrcDt11));
  dst_ds0.s1 =(int) *((__global uchar*)(dst_dsSrcDt11+1));

  // dst_ds[(M+1)/2-1][ity]
  int dst_dsSrcIdx9 = dst_dsSrcShift + 1023 *dst_dsSrcStep + ((float)gidx) *sizeof(unsigned char);
  __global unsigned char *dst_dsSrcDt9 = dst_dsSrc + dst_dsSrcIdx9;
  //dst_ds1 = (convert_int2)(*((__global uchar2*)(dst_dsSrcDt9)));
  dst_ds1.s0 = (int) *((dst_dsSrcDt9));
  dst_ds1.s1 = (int)*((dst_dsSrcDt9+1));
  //dst_ds2 = (convert_int2)(*((__global uchar2*)(dst_dsSrcDt14)));
  //dst_ds2.s0 =(int) *((dst_dsSrcDt14));
  //dst_ds2.s1 =(int) *((dst_dsSrcDt14+1));
  //dst_ds3 = (convert_int2)(*((__global uchar2*)(dst_dsSrcDt16)));
  dst_ds3.s0 = (int)*((dst_dsSrcDt16));
  dst_ds3.s1 = (int)*((dst_dsSrcDt16+1));
  ...
  /* kernel operation */
  {
    if (gidy == 0) {
      ...
      *layerDstDt1 = src0.s0 - dst_ds0.s0;
      if (gidx != 1023)
        *(layerDstDt1+1) = src0.s1 - ( dst_ds0.s0 + dst_ds0.s1 + 1)>>1;
      //layer0.s1 = src0.s1 - ((dst_ds0.s0 + dst_ds0.s1 + 1)/2);
      if (gidx == 1023 &&  widthOdd == 0)
        *( layerDstDt1 + 1 ) = src0.s1 - dst_ds0.s0;
        //layer0.s1 = src0.s1 - dst_ds0.s0;
      //*((__global uchar2*)(layerDstDt1)) = (convert_uchar2)(layer0);
      //*(layerDstDt1) = (uchar)(layer0.s0);
      //*(layerDstDt1+1) = (uchar)(layer0.s1);
    }

    if (heightOdd == 0 && gidy == 1023) {
      ...
      *((__global uchar*)(layerDstDt3)) = (uchar)(layer1.s0);
      *((__global uchar*)(layerDstDt3+1)) = (uchar)(layer1.s1);
    }
    ...
    if (gidy != 0) {
      ...
      if (widthOdd == 0 && gidx == 1023) {
        layer2.s1 = src2.s0 - ((dst_ds2.s0 + dst_ds3.s0 +1)/2); 
        layer3.s1 = src3.s0 - dst_ds3.s0;
        //*layerDstDt6 = src2.s0 -((dst_ds2.s0 + dst_ds3.s0 +1)>>1); 
      ...
      *((__global uchar*)(layerDstDt5)) = (uchar)(layer2.s0);
      *((__global uchar*)(layerDstDt5+1)) =(uchar)(layer2.s1);
      *((__global uchar*)(layerDstDt7)) = (uchar)(layer3.s0);
      *((__global uchar*)(layerDstDt7+1)) = (uchar)(layer3.s1);
...
#if 1
  if( gidx == 0 && gidy == 0 ){
  printf("src: src00 = %d, src01 = %d, src10 = %d, src11 = %d \n",
      src0.s0, src0.s1, src1.s0, src1.s1);
  printf("src: src20 = 0, src21 = 0, src30 = %d, src31 = %d \n",
       src3.s0, src3.s1);
  printf("dst_ds: dst_ds00 = %d, dst_ds01 = %d, dst10 = %d, dst11 = %d \n",
      dst_ds0.s0, dst_ds0.s1, dst_ds1.s0, dst_ds1.s1);
  printf("src: src20 = 0, src21 = 0, dst_ds30 = %d, dst_ds31 = %d \n",
       dst_ds3.s0, dst_ds3.s1);
  }
#endif
