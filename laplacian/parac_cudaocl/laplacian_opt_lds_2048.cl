  ...
  int layerDstShift)
{
  ...
  // layer[M-1][ity*2]
  //int layerDstIdx3 = layerDstShift + 2047 *layerDstStep + (gidx * 2);
  //__global unsigned char *layerDstDt3 = layerDst + layerDstIdx3;
  __global unsigned char *layerDstDt3 = mad24(2047, layerDstStep, layerDstShift) + mad24(gidx, 2 , layerDst) ;
  ...
  int SrcSrcIdx3 = SrcSrcShift + 2047 *SrcSrcStep + (gidx * 2) ;
  ...
  // dst_ds[(M+1)/2-1][ity]
  int dst_dsSrcIdx9 = dst_dsSrcShift + 1023 *dst_dsSrcStep + (gidx);
