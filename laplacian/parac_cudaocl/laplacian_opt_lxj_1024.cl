  ...
  int dst_horizonDstShift)
{
  ...
  /* kernel operation */
  {
    ...
    if ( gidx == 0 ){ 
      ...
      pre.s0 = ((SrcMid0.s3 - SrcMid0.s1)<<2) + (SrcMid0.s0<<1) - SrcMid0.s2;
      ...
      lat.s0 = (SrcMid0.s2<<1) - SrcMid0.s0;
      lat.s1 = ((SrcMid0.s0  - SrcMid0.s2)<<2)+ (SrcMid0.s3<<1) - SrcMid0.s1;
    }
...
// Index and Operand for BorderRule 
    ...
    int dst_horizonBRIndex7 = dst_horizonSrcShift + (1020) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
    int dst_horizonBRIndex10 = dst_horizonBRIndex7 + dst_horizonSrcStep;
    int dst_horizonBRIndex6 = dst_horizonBRIndex10 + dst_horizonSrcStep;
    int dst_horizonBRIndex8 = dst_horizonBRIndex6 + dst_horizonSrcStep;

   // int dst_horizonBRIndex8 = dst_horizonSrcShift + (1023) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
   // int dst_horizonBRIndex6 = dst_horizonSrcShift + (1022) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
   // int dst_horizonBRIndex10 = dst_horizonSrcShift + (1021) *dst_horizonSrcStep + ((float)gidx * 2) *sizeof(unsigned char);
...
__global unsigned char *layerDstDt3 = mad24(1023, layerDstStep, layerDstShift) + gidx * 2 + layerDst ;
